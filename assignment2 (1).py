...
train_data = '/content/drive/MyDrive/comp5349/test.json'
df= spark.read.option('multiline', 'true').json(train_data)
...
df = df.select('data', 'context', explode("data.qas").alias("qas"))\
